...
describe('DetailService', () => {
  ...
  it('should get data for detail page', async () => {
    ...
    const spyOnWorkOnService = jest.spyOn( workOnService, 'findAllByShiftId').mockResolvedValueOnce(mockFindAllByShiftId);
    const spyOnAccountService = jest.spyOn( accountService, 'findByIds').mockResolvedValueOnce(mockFindByIds);
    const spyOnRequestService = jest.spyOn( requestService, 'getRequest').mockResolvedValue(mockGetRequest);
