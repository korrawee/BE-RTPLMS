...
describe('RequestController', () => {
    ...
    it('should get all request by given shiftCode and date', async () => {
        ...
        const spyOnGetAllRequestByShiftAndDate = jest
            .spyOn(service, 'getAllRequestByShiftAndDate')
            .mockResolvedValueOnce(expectResult);
        expect(service.getAllRequestByShiftAndDate).toBeCalledWith(
            shiftCode,
            date
        );
    });
    ...
    it('it should create ot request given number of person sort by chcek in time', async () => {
        ...
        const spyOnCreateOtRequest = jest
            .spyOn(service, 'createOtRequest')
            .mockResolvedValueOnce(expectResult);
